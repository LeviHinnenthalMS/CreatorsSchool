...
import type { SanityLink, PageOrPost } from '@/sanity/typeHelpers'
		...
		<nav className="section py-4 text-sm">
			...
			>
				...
				<Crumb position={(crumbs?.length || 0) + 2} hidden={hideCurrent}>
					{('title' in (currentPage ?? {}) && (currentPage as { title?: string }).title) ||
