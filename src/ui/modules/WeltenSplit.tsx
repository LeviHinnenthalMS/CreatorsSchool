			...
			<div className="wrap">
				...
				<div className="grid grid-cols-1 gap-[18px] md:grid-cols-2">
					{cards.map((c, i) => {
						...
						const baseCls = cn(
							'group/welt relative flex min-h-[420px] flex-col justify-between gap-7 overflow-hidden rounded-[30px] border p-[clamp(34px,3.6vw,54px)] text-inherit no-underline transition-transform duration-500 hover:-translate-y-1.5',
							dark
