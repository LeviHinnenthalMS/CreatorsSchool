...
function buildOfferings(phId: string) {
	...
	return offerings.filter(
		(offering) =>
			offering.order <= 20 &&
			offering._id !== O.hochzeit &&
			offering._id !== O.instrument,
	)
}
				...
				cards: [
					{
						...
						text: 'Eltern-Kind-Kurse und musikalische Frühförderung. Von 1,5 bis 3 Jahren gemeinsam mit Mama oder Papa, von 3 bis 6 Jahren in der Gruppe.',
					...
					},
					{
						...
						text: 'Tänzerische Früherziehung für Drei- bis Sechsjährige. Ballett ab sechs und Modern-/Contemporary dance ab acht Jahren. Mit echten Aufführungen, echtem Bühnenbild, echter Energie.',
		...
		columns: [
			{
				...
				links: [
					...
					footerLink('Modern-/Contemporary dance', P.aJazz),
