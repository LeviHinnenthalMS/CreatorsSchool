...
const O = {
	...
	// tanz stage cards (home grid only, order >= 21)
	ballettAb9: 'offering-ballett-ab-9',
	mdAb10: 'offering-moderndance-ab-10',
	mdAb15: 'offering-moderndance-ab-15',
	mdAb18: 'offering-moderndance-ab-18',
	mdAb30: 'offering-moderndance-ab-30',
}
	...
	return [
		{
			...
			heroImage: hero,
			facts: facts([['Alter', '4–6 Jahre'], ['Typ', 'Kleingruppe · max. 6 Kinder'], ['Probestunde', 'kostenlos']]),
		...
		},
		{
			...
			heroImage: hero,
			facts: facts([['Alter', 'ab 3 Jahren'], ['Dauer', '45 Min / Woche'], ['Gruppe', 'Max. 8 Kinder'], ['Preis', '€16 / Kind']]),
		...
		// ── Tanz stage cards (home tanz-grid only, order >= 21) ────────────
		{
			...
			heroImage: hero,
			facts: facts([['Alter', 'ab 9 Jahren'], ['Dauer', '60 Min / Woche'], ['Niveaus', '2 Stufen'], ['Preis', 'ab €22']]),
			...
			forWho: forWho([
				...
				['Tänzer:innen mit Bühnenambitionen', 'Unser Juniorballett bereitet auf die Jahresaufführung vor.'],
			]),
			...
			learn: learnCards([
				...
				['stage', 'Aufführung', 'Choreografie und Bühnenvorbereitung für die Jahresaufführung.'],
			]),
			detailsTitle: rt('Der Kurs auf einen *Blick*.'),
			priceLabel: 'ab', priceCurrency: '€', priceValue: '22', priceUnit: '/ Kind',
			detailRows: detailRows([['Dauer', '60 Min / Woche'], ['Niveaus', '2 Stufen'], ['Aufführung', 'Jährlich'], ['Probestunde', 'Kostenlos']]),
			faqTitle: rt('Gut zu *wissen*.'),
			faq: faq([
		...
		},
		{
			...
			heroImage: hero,
			facts: facts([['Alter', 'ab 10 Jahren'], ['Dauer', '60 Min / Woche'], ['Niveaus', 'Einsteiger'], ['Preis', '€24 / Person']]),
			...
			learn: learnCards([
				...
				['stage', 'Bühne', 'Auftritte und Vorbereitung auf die Jahresaufführung.'],
			]),
			detailsTitle: rt('Der Kurs auf einen *Blick*.'),
			priceLabel: '', priceCurrency: '€', priceValue: '24', priceUnit: '/ Person',
			detailRows: detailRows([['Dauer', '60 Min / Woche'], ['Level', 'Einsteiger'], ['Probestunde', 'Kostenlos']]),
			faqTitle: rt('Gut zu *wissen*.'),
			faq: faq([
				['Brauche ich Tanzerfahrung?', 'Nein — wir starten gemeinsam von Grundpositionen. Freude an Bewegung genügt.'],
				['Gibt es Auftritte?', 'Ja — mehrmals im Jahr, darunter unsere große Jahresaufführung.'],
			]),
		...
		},
		{
			...
			heroImage: hero,
			facts: facts([['Alter', 'ab 15 Jahren'], ['Dauer', '75 Min / Woche'], ['Niveaus', 'Fortgeschritten'], ['Preis', '€24 / Person']]),
			...
			forWho: forWho([
				...
				['Alle mit Bühnenambitionen', 'Regelmäßige Auftritte und die Vorbereitung auf die Jahresaufführung.'],
			]),
			...
			learn: learnCards([
				...
				['stage', 'Performance', 'Auftritte und Bühnenreife für die Jahresaufführung.'],
			]),
			detailsTitle: rt('Der Kurs auf einen *Blick*.'),
			priceLabel: '', priceCurrency: '€', priceValue: '24', priceUnit: '/ Person',
			detailRows: detailRows([['Dauer', '75 Min / Woche'], ['Level', 'Fortgeschritten'], ['Probestunde', 'Kostenlos']]),
			faqTitle: rt('Gut zu *wissen*.'),
			faq: faq([
		...
		},
		{
			...
			learn: learnCards([
				...
				['stage', 'Performance', 'Auftritte und Bühnenpräsenz für die Jahresaufführung.'],
			]),
			detailsTitle: rt('Der Kurs auf einen *Blick*.'),
			priceLabel: '', priceCurrency: '€', priceValue: '24', priceUnit: '/ Person',
			detailRows: detailRows([['Dauer', '75 Min / Woche'], ['Format', 'Erwachsenengruppe'], ['Probestunde', 'Kostenlos']]),
			faqTitle: rt('Gut zu *wissen*.'),
			faq: faq([
		...
		},
		{
			...
			faq: faq([
				...
				['Gibt es Auftritte?', 'Nur für die, die wollen. Wir laden zur Jahresaufführung ein — als Zuschauer:in oder auf der Bühne.'],
			]),
